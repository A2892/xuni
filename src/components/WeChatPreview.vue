                ...
                <template v-else-if="message.type === 'red_packet'">
                  <div class="redpacket-message">
                    ...
                    <div class="redpacket-info">
                      ...
                      <div class="redpacket-subtitle">微信红包</div>
                    </div>
                  </div>
                </template>
              </div>
...
import type { WeChatChat, WeChatSettings } from '@/stores/wechat'

const props = defineProps<{
  currentChat: WeChatChat | undefined
